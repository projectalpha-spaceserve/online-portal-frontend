  ...
  return (
    <div>
      <form className="space-y-5">
        <div className="">
          <label className="text-xs">Enter Current Passcode:</label>
          <input
            type="text"
        ...
        <div className="">
          <label className="text-xs">Enter New Passcode:</label>
          <input
            type="text"
            className="border border-brand-75 block py-2 px-5 w-full rounded-md mt-1"
          />
        ...
        <div className="">
          <label className="text-xs">Confirm New Passcode:</label>
          <input
            type="text"
            className="border border-brand-75 block py-2 px-5 w-full rounded-md mt-1"
          />
